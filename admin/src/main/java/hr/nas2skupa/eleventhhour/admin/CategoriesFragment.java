...
import hr.nas2skupa.eleventhhour.admin.viewholders.CategoryViewHolder;
...
public class CategoriesFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseRecyclerAdapter<Category, CategoryViewHolder> adapter = new FirebaseRecyclerAdapter<Category, CategoryViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull final CategoryViewHolder viewHolder, int position, @NonNull Category model) {
                ...
                viewHolder.itemView.setOnClickListener(view -> startCategoryActivity(viewHolder.itemView, categoryKey));
            }
        };
