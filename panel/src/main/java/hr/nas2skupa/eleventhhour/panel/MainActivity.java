...
public class MainActivity extends AppCompatActivity
    ...
    void initWeekView(final WeekView weekView) {
                ...
                switch (weekView.getNumberOfVisibleDays()) {
                    case 1:
                        return new SimpleDateFormat("EEEE, ", Locale.getDefault()).format(date.getTime())
                                + DateFormat.getLongDateFormat(MainActivity.this).format(date.getTime());
                    case 3:
 ...
 */
            ...
            public String interpretTime(int hour) {
                ...
                try {
                    SimpleDateFormat sdf = DateFormat.is24HourFormat(MainActivity.this) ? new SimpleDateFormat("HH:mm", Locale.getDefault()) : new SimpleDateFormat("hh a", Locale.getDefault());
